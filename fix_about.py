with open('Shikha portfolio v1-enhanced.html', 'r', encoding='utf-8', errors='replace') as f:
    content = f.read()
...
if old in content:
    ...
    if ob == cb and op == cp:
        ...
        with open('Shikha portfolio v1-enhanced.html', 'w', encoding='utf-8') as f:
            f.write(content)
        print('SUCCESS: desktop')
    else:
        print('ERROR: unbalanced new string')
else:
