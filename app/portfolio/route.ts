...
(function(){
  function move(){
    ...
    brand.innerHTML='<span style="font-family:\\'Uber Move\\',sans-serif;font-size:22px;font-weight:700;color:#2D2A26;display:block;line-height:1.2">Dr Shikha Soni</span><span style="font-size:12px;letter-spacing:0.2em;color:#8A8580;display:block;margin-top:2px">CLINICAL PSYCHOLOGIST</span>';
